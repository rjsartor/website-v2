...
const CONTENT_PARAGRAPH_1: string =
    "My name is Randy and I've always been fascinated by ideas. After studying philosophy and international relations at Northeastern University and starting my career in operations management, I became a software engineer to help turn great ideas into life-changing experiences. In my first professional role, I removed barriers to healthcare by building applications and services used by doctors and medical scribes.";

const CONTENT_PARAGRAPH_2: string =
    //   "Now I'm looking for opportunities where I can continue to build impactful products while growing into an engineering leader. I'm a full stack generalist, but wouldn't mind specializing for the right role. I'm most inspired by mission-driven work and strive to skills to make a positive impact.";
    "I'm currently a Senior Full Stack Software Engineer at PVcase, building a single end-to-end platform for solar energy development.";
